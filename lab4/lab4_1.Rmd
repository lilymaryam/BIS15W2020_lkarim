...
## Load the tidyverse
```{r}
library(tidyverse) #make sure tidyverse is up to date
```
...
#r requires a long for of the data set. the column names(drug samples) were variables
...
**This data is untidy because there should be an observation for every religion at every income level. All of the income variables should be made longer**  
...
This is not tidy because every day should be in a single column called day 
